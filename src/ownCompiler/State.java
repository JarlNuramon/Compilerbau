 ...
 */
public enum State {
	NO_TYPE(-1, 0), EOF(-1, 255), START(0, 5, new String[]{}, new String[]{","},
			...
			new String[]{"=="}), KOMMA(0, 7, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{},
					...
					new String[]{}, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{},
					new String[]{}, new String[]{}, new String[]{}), IDENT(0, 8,
							...
							new String[]{}, new String[]{}, new String[]{},
							new String[]{}, new String[]{}, new String[]{},
							new String[]{}, new String[]{}), OPEN_PAR(0, 9,
									new String[]{}, new String[]{},
									new String[]{}, new String[]{},
									new String[]{}, new String[]{},
									new String[]{}, new String[]{},
									...
									new String[]{}, new String[]{},
									new String[]{}, new String[]{},
									new String[]{}, new String[]{}), CLOSE_PAR(
											0, 10, new String[]{},
											new String[]{}, new String[]{},
											new String[]{}, new String[]{},
											new String[]{}, new String[]{},
	...
	State(int prio, Integer token, String[] transitionStart,
		...
		this.transitionBoolOperator = new String[]{};
	}
	...
	State(int prio, Integer token, String[] transitionStart,
			...
			String[] transitionProgram, String[] transitionRightExpression,
			String[] transitionLet, String[] transitionIf,
			String[] transitionWhile, String[] boolOperator) {
		this.prio = prio;
		this.token = token.byteValue();
		this.transitionStart = transitionStart;
		this.transitionKomma = transitionKomma;
		...
		this.transitionIf = transitionIf;
		this.transitionWhile = transitionWhile;
		this.transitionBoolOperator = boolOperator;

package ownCompiler;/*
		    ...
		    im Syntaxbaum f�r die Grammatik unseres Parsers zur Verf�gung.
		    ...
		    Subklassen der Klasse Semantik durch �berschreiben der Methode f(t,n)
		    zu realisieren.	
		    */
...
public class Semantic {
    ...
    // Der Parameter t repr�sentiert einen Teilbaum des Syntaxbaumes, wobei
    ...
    // durch eine Funktion g:Z->Z ausgedr�ckt werden muss, wird bei f noch
    // ein zweiter Parameter �bergeben, der die Definitionsmenge von g
    // aufnimmt.
    //

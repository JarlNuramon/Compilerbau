...
class SyntaxTree implements TokenList {
    ...
    void setSemantikFunction(byte b) {
        switch (b) {/*
			case 1: value=new professorstuff.Expression();
					break;
			case 2: value=new professorstuff.RightExpression();
					break;
			case 3: value=new professorstuff.Term();
					break;
			case 4: value=new professorstuff.RightTerm();
					break;
			case 5: value=new professorstuff.Num();
					break;
			case 6: value=new professorstuff.Operator();
					break;
